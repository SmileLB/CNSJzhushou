...
public class CommonParamsInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        Request request = chain.request();//当发出请求时，该拦截器会拦截最原始的请求

        try {
            String method = request.method();//获取该请求的方式
            ...
            if (method.equals("GET")) {
                ...
                Set<String> parametNames = httpUrl.queryParameterNames();
                for (String key : parametNames) {
